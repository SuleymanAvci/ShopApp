...
namespace shopapp.data.Concrete.EfCore
{
    public static class SeedDatabase
    {
        ...
        private static Category[] Categories={
            ...
            new Category(){Name="Bilgisayar",Url="elektronik"},
            new Category(){Name="Elektronik",Url="bilgisayar"},
        ...
        private static Product[] Products={
            ...
            new Product(){Name="Samsung S6",Url="samsung-s6",Price=3000,ImageUrl="2.jpg",Description="iyi telefon", IsApproved=true },
